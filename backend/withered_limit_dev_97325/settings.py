"""
Django settings for withered_limit_dev_97325 project.
...
ROOT_URLCONF = 'withered_limit_dev_97325.urls'
...
WSGI_APPLICATION = 'withered_limit_dev_97325.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "withered_limit_dev_97325 API",
    "DESCRIPTION": "API documentation for withered_limit_dev_97325 App",
    "VERSION": "v1",
}
