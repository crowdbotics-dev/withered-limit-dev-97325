...
## Project Structure
    ...
    ├── withered_limit_dev_97325  # Django project configurations
...
1. Clone this repo and `cd withered_limit_dev_97325`
...
2. Clone this repo and `cd withered_limit_dev_97325`
